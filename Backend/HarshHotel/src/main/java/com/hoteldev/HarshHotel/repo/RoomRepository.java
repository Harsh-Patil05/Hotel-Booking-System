...
public interface RoomRepository extends JpaRepository<Room,Long> {
    ...
    @Query("SELECT r FROM Room r WHERE r.roomType LIKE %:roomType% AND r.id NOT IN(SELECT bk.room.id FROM Booking bk WHERE bk.checkOutDate > :checkInDate AND bk.checkInDate < :checkOutDate)")
